    ...
    return(
        <div className={`h-full min-h-screen bg-[#1d1d1d] text-white`}>
            ...
            <div className="coin border text-white border-[#1d1d1d] bg-[#282828] w-11/12 mx-auto px-2 pt-3 pb-4 mt-4 rounded-md">
                ...
                <h1 className="flex pl-4 text-4xl font-bold"><img src={"/coin.svg"} height={40} width={40} className="mr-1" alt='done' />6122</h1>
            </div>
            </div>
            ...
            {/* The Last part */}
            <div className="last" style={{ paddingBottom: '60px', overflowY: 'auto' }}>
